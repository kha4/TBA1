...
def createObjectList(newGame):
	...
	desk = {'Name': 'Desk', 'Description': 'Looks like an ordinary desk. There are books scattered around. Someone was reading "Rafts for Dummies". Looks intriguing.', 'Location': 'Library', 'Movable': 'n'}
	...
	fence = {'Name': 'Fence', 'Description': 'This barbed wire fence is keeping prisoners inside of the yard. Does not seem too high though. You can see the shore from here.', 'Location': 'Yard', 'Movable': 'y'}
